...
class Pool(GObject.GObject):
    __gsignals__ = {
        'added': (GObject.SIGNAL_RUN_FIRST, None, (object, object)),
...
class Producer(Pool):
    ...
    def add(self, *args, **kwargs):
        ...
        producer.connect('register-success', lambda n, p, d=None: self.emit('added', name, producer))
        producer.connect('register-failed', lambda n, d=None: self.remove(name))
...
class MixPool(GObject.GObject):
    __gsignals__ = {
        'producer-added': (GObject.SIGNAL_RUN_FIRST, None, (object, object)),
        'producer-removed': (GObject.SIGNAL_RUN_FIRST, None, (object, )),
        'consumer-added': (GObject.SIGNAL_RUN_FIRST, None, (object, object)),
        'consumer-removed': (GObject.SIGNAL_RUN_FIRST, None, (object, )),
    }

    def __init__(self, producerKlass=NDN.Producer, consumerKlass=NDN.Consumer, *args, **kwargs):
